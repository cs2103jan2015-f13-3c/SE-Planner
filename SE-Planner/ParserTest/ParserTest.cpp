...
namespace ParserTest{
	...
	public:
		...
		TEST_METHOD(ParserTestInputAddMethod){
			...
			expectedResult.push_back("FLOATING task one");
		...
		TEST_METHOD(ParserTestAddWithDateOnlyMethod){
			...
			std::vector<std::string> expectedResult;
			expectedResult.push_back("d1 DEADLINE task date w/o range");
			expectedResult.push_back("add d2 date w range");
		...
		TEST_METHOD(ParserTestAddWithDateTimeMethod){
			...
			std::vector<std::string> expectedResult;
			expectedResult.push_back("t2d1 time w range, date w/o range");
			expectedResult.push_back("t1d2 ERROR time w/o range, date w range");
			expectedResult.push_back("add t1d1 TIMED task time w/o range, date w/o range");
			expectedResult.push_back("add t2d2 CORRECT time w range, date w range");
